# ORB_SLAM3_ROS2 (Fix Compile Issue)
This repository is ROS2 wrapping to use ORB_SLAM3
Fix compile issue on ubuntu 22.04(VM)
...
# 使用ROS2啟動(mono, 單目視覺)
ros2 run orbslam3 mono ~/ORB_SLAM_ROS2/src/orbslam3_ros2/vocabulary/ORBvoc.txt ~/ORB_SLAM_ROS2/src/orbslam3_ros2/config/monocular/EuRoC.yaml
```
  - `STEREO` mode  
```
$ ros2 run orbslam3 stereo PATH_TO_VOCABULARY PATH_TO_YAML_CONFIG_FILE BOOL_RECTIFY

# 使用ROS2啟動(stereo, 雙目視覺)
ros2 run orbslam3 stereo ~/ORB_SLAM_ROS2/src/orbslam3_ros2/vocabulary/ORBvoc.txt ~/ORB_SLAM_ROS2/src/orbslam3_ros2/config/stereo true
